...
void EditorWorld::enterEditorWorld()
{
 ...
 */
void EditorWorld::getKartsDisplayInfo(
...
void EditorWorld::createRaceGUI()
{
...
void EditorWorld::onFirePressed(Controller* who)
{
 ...
 */
void EditorWorld::onMouseClick(int x, int y)
{
